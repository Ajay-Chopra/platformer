...
# Game over screen
GAME_OVER_BASE_IMAGE_PATH = "../level/ui_base_images/game_over_2.png"
GAME_OVER_BASE_IMAGE_POS = (SCREEN_WIDTH / 2, SCREEN_HEIGHT / 2)
GAME_OVER_BANNER_TEXT_POS = (SCREEN_WIDTH / 2 - 36, 105)
GAME_OVER_RECAP_TEXT_POS = (450, 200)
GAME_OVER_GOLD_COIN_IMAGE_POS = (500, 250)
GAME_OVER_GOLD_COIN_TEXT_POS = (530, 250)
GAME_OVER_SILVER_COIN_IMAGE_POS = (500, 300)
GAME_OVER_SILVER_COIN_TEXT_POS = (530, 300)
GAME_OVER_PROGRESS_TEXT_POS = (500, 350)
GAME_OVER_RESTART_TEXT_POS = (465, 485)
GAME_OVER_OVERWORLD_TEXT_POS = (450, 550)
GAME_OVER_QUIT_GAME_TEXT_POS = (670, 515)
